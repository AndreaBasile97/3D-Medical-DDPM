...
# Check and display the GPU being used
...
)  # epochs parameter specifies the number of training iterations
...
if with_condition:
    ...
    dataset = NiftiImageGenerator(
        inputfolder, input_size=input_size, depth_size=depth_size, transform=transform
    )
